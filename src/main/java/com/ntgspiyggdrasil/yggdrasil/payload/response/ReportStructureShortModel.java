...
@Data
@NoArgsConstructor
public class ReportStructureShortModel {
    public static ReportStructureShortModel toModel(ReportStructure entity) {
        ReportStructureShortModel model = new ReportStructureShortModel();
